...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "AI Chatbot (100 confirmations / mois)",
      "AI Confirmation (Arabe / Français)",
      "Intégrations livraison (bientôt)",
      "Numéro de tracking (bientôt)",
      "Automatisations de base (bientôt)",
    ],
    flags: proFlags,
  },
  {
    ...
    features: [
      ...
      "AI avancée + quota supérieur (bientôt)",
      "Risk scoring (bientôt)",
      "Relances automatiques (bientôt)",
      "Bulk shipping (bientôt)",
      "Comparaison entre boutiques (bientôt)",
      "Support prioritaire",
    ],
    flags: businessFlags,
  },
