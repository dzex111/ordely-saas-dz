    ...
    <div className="grid min-h-dvh lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-ink text-white lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          <Link href="/" aria-label="ORDELY - home" className="inline-block rounded-xl bg-white p-2.5"><img src="/logo.svg" alt="ORDELY" className="h-7 w-auto" /></Link>
          <div>
      ...
      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          <Link href="/" aria-label="ORDELY - home" className="mb-10 block lg:hidden"><img src="/logo.svg" alt="ORDELY" className="h-7 w-auto" /></Link>
