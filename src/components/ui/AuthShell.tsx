    ...
    <div className="grid min-h-dvh lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-ink text-white lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          <Link href="/" aria-label="ORDELY - home"><img src="/logo.svg" alt="ORDELY" className="h-6 w-auto brightness-0 invert" /></Link>
          <div>
      ...
      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          <Link href="/" aria-label="ORDELY - home" className="mb-10 block lg:hidden"><img src="/logo.svg" alt="ORDELY" className="h-5 w-auto" /></Link>
